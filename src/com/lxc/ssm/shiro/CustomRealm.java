...
import com.lxc.ssm.po.ActiveUser;
import com.lxc.ssm.po.SysPermission;
import com.lxc.ssm.po.SysUser;
import com.lxc.ssm.service.SysService;

//自定义realm
//相当于是controller,在方法里面注入service
...
//		从数据库中取出的数据放入activeUser中
		...
		//将activeUser设置在simpleAuthenticationInfo里
		SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(
...
*/		//....
		...
		//将上边查询到授权信息填充到simpleAuthorizationInfo对象中，因为simpleAuthorizationInfo的添加方法是一个集合对象，所以就需要把所有的权限信息填充到集合中。
